...
import { Mail, Phone, MapPin, Clock, Send, CheckCircle2, Gift } from 'lucide-react'
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '64px', alignItems: 'start' }} className="contact-grid">
            ...
            <div>
              ...
              <div style={{ background: 'linear-gradient(135deg,#1A56DB,#2563EB)', borderRadius: '16px', padding: '24px', color: '#fff' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: 'rgba(255,255,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '12px' }}>
