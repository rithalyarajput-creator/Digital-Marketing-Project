      ...
      <div className="container" style={{ paddingTop: "72px", paddingBottom: "32px" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              {[
                ...
                <a key={s.label} href="#" aria-label={s.label} style={{ width: "36px", height: "36px", borderRadius: "9px", background: "rgba(255,255,255,0.08)", display: "flex", alignItems: "center", justifyContent: "center", transition: "background 0.2s" }}
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "10px" }}>
              {links.services.map((l, i) => (
                <li key={l}><Link href={hrefs.services[i]} style={{ fontSize: "14px", color: "#94A3B8", textDecoration: "none", transition: "color 0.15s" }}
                  onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = "#fff"}
                  onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = "#94A3B8"}>{l}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: "10px" }}>
              {links.company.map((l, i) => (
                <li key={l}><Link href={hrefs.company[i]} style={{ fontSize: "14px", color: "#94A3B8", textDecoration: "none", transition: "color 0.15s" }}
                  onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = "#fff"}
                  onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = "#94A3B8"}>{l}</Link></li>
              ))}
            </ul>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "28px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
          ...
          <div style={{ display: "flex", gap: "24px" }}>
            <Link href="/privacy" style={{ fontSize: "13px", color: "#475569", textDecoration: "none" }}>Privacy Policy</Link>
            <Link href="/terms" style={{ fontSize: "13px", color: "#475569", textDecoration: "none" }}>Terms of Service</Link>
          </div>
        </div>
      </div>
